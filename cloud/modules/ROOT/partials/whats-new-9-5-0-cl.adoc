...
In this release, there is a new ServiceNow Incident Management SpotApp which allows you to use the ServiceNow Snowflake connector to move your data from ServiceNow to Snowflake.
