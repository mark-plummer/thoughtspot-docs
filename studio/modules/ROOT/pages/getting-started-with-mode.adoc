...
{brand} can directly connect to link:https://mode.com/data-sources/[many popular databases,window=_blank], all you have to do is simply enter the appropriate security credentials.
