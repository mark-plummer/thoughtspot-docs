...
With {form-factor}, it's as simple as connecting a data source, coaching {form-factor} on the types of questions you want to ask, and then chatting with Spotter to get answers.
