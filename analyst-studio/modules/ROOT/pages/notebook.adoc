...
The Notebook's moveable code blocks and markdown cells enable exploratory data analysis, visualization, and collaboration.
...
** Compose code and view results in a *Code* cell, or contextualize your work with a link:https://en.wikipedia.org/wiki/Markdown[Markdown] cell.
* *Resources Panel*
...
*Markdown* - link:https://en.wikipedia.org/wiki/Markdown[Markdown] cells allow you to add context to your analysis.
...
*Python:* link:https://pandas.pydata.org/pandas-docs/stable/dsintro.html#dataframe[pandas DataFrame]

*R:* link:https://www.rdocumentation.org/packages/base/versions/3.6.1/topics/data.frame[Data Frame]
...
Each environment comes pre-loaded with the following libraries:+++<supported-libraries-table type="Python">++++++</supported-libraries-table>+++
...
The Notebook supports R version 4.2.0 and comes pre-loaded with the following R packages:+++<supported-libraries-table json="https://mode.github.io/runtimes/r.json" type="R">++++++</supported-libraries-table>+++
...
This means that manually installed versions of popular and interactive libraries like Plotly, Bokeh, and ipywidgets will not function as expected even if the package install appears to succeed.
...
First, enter the following command into a Notebook cell for each public package that you want to install into the Python Notebook, as demonstrated below with the link:https://pypi.org/project/bloom-filter/[bloom-filter] package (replace `bloom-filter` with the name of the package you want to install):
...
First, enter the following command into a Notebook cell for each public package that you want to install into the R Notebook, as demonstrated below with the link:https://cran.r-project.org/web/packages/random/index.html[random] package (replace `random` with the name of the package you want to install):
...
| link:https://mode.com/compare-plans/[*Mode Paid Plans*]
| 16 GB
| 16 Cores
| 12 hours
| 60 minutes
...
To access the tutorial, please visit the link:https://mode.com/python-tutorial/[page here].
If you're interested in learning SQL as well, you can access this link:https://mode.com/sql-tutorial/[page here].
