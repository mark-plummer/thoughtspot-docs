...
ThoughtSpot Cloud 9.12.5.cl is now available.
...
For more information, see xref:liveboard-filters.adoc[Livebaord filters].
...
Snowflake Query Profile SpotApp:: The Snowflake Query Profile SpotApp is now available. Use this SpotApp to analyze Snowflake query data to understand execution time better and pinpoint key areas for query optimization.
//For more information, see
...
The DEI Workforce Diversity SpotApp is now available. Get invaluable insight into your workforce diversity data from your HR application.
