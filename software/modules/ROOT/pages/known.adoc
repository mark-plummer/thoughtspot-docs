...
On the homepage, by default the number of views for Liveboards and Answers in the Liveboards & Answers listing section appear as 0. This is a bug which ThoughtSpot is fixing and the fix will be available in a separate patch."


*Conditions*:

The Navigation and Homepage is set to _Classic experience_
