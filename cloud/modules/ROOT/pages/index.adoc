...
<li><a href="https://docs.thoughtspot.com/cloud/latest/thoughtspot-sheets">ThoughtSpot Analytics for Google Sheets&trade;</a></li>
    </ul>
    </div>
  <div class="box">
...
<li><a href="https://docs.thoughtspot.com/cloud/latest/dbt-integration">Integrate with dbt</a></li>
      ...
      <div class="box">
       ...
       <li><a href="https://docs.thoughtspot.com/cloud/latest/authentication-integration">SAML authentication</a></li>
          ...
          <li><a href="docs.thoughtspot.com/cloud/latest/consumption-pricing">Consumption-based pricing</a></li>
        </ul>
        </div>
 </div>
...
include::partial$whats-new-9-5-0-cl.adoc[What's new in 9.5.0.cl]