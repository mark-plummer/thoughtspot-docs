...
. Navigate to the link:https://app.mode.com/home/[{brand} home page] and (if necessary) sign in to {brand}.
...
To see a list of all the starred reports, regardless of where they live, click on *Starred* on the left side of your link:https://app.mode.com/home/[{brand} home page].
