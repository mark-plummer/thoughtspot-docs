...
[#preview-sage]
Can preview ThoughtSpot Sage:: Users with this privilege can use the Early Access ThoughtSpot Sage features. These features must first be enabled by your administrator. For more information about Early Access features, see xref:release-lifecycle.adoc#early-access[Early Access features]. These features include xref:ai-answers.adoc[], xref:search-ai-suggested.adoc[], and xref:spotiq-change.adoc#change-analysis-contextual[Contextual change analysis]. You do not need this privilege for the xref:data-modeling-visibility.adoc#automatic-synonyms[AI-generated Worksheet synonyms] feature.
...
>>>>>>> 1b18675f3 (SCAL-205511 - remove Cannot copy or edit existing Liveboards)
