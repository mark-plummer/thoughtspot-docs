...
<li><a href="https://docs.thoughtspot.com/software/latest/worksheet-create-setup">Create worksheets during Setup</a></li>
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><a href="https://docs.thoughtspot.com/software/latest/connections-cust-cal">Custom calendar</a></li>
<li><a href="https://docs.thoughtspot.com/software/latest/connections-external-tables-intro">Query external tables</a></li>
<li><a href="https://docs.thoughtspot.com/software/latest/connections-passthrough">Passthrough functions</a></li>
<li><a href="https://docs.thoughtspot.com/software/latest/connections-query-tags">Query tags</a></li>
