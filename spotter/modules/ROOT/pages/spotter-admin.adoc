...
. Click *Send invite*.
+
When the person receives the email invitation, they click *Join now*, and the _Welcome to ThoughtSpot Spotter_ page opens in a web browser. At that point, they enter their email address, create a password, and then click *Start Now*. They are then signed in to Spotter.
