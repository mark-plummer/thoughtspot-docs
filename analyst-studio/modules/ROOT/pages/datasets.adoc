...
Check out our {brand} University learning path, link:https://university.mode.com/path/self-serve-infrastructure-datasets[Building Self-Serve Infrastructure with Datasets], to learn more about developing a Datasets strategy.
...
You can learn more about creating a Dataset access and permissions strategy in this {brand} University course, link:https://university.mode.com/building-datasets-for-self-serve-analytics/1564645/scorm/18mar8c4v6a60[Dataset organization & permissions best practices].
