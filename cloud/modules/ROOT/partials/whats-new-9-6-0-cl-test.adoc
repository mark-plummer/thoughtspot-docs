...
+++
<video autoplay loop muted width="800" controlsList="nofullscreen nodownload">
<source src="https://docs.thoughtspot.com/cloud/9.12.0.cl/_images/scroll_homepage_test.mp4" type="video/mp4">
</video>
+++

*Controls, looped autoplay, no fullscreen, no download*

+++
<video autoplay loop muted controls width="800" controlsList="nofullscreen nodownload">
<source src="https://docs.thoughtspot.com/cloud/9.12.0.cl/_images/scroll_homepage_test.mp4" type="video/mp4">
</video>
+++
