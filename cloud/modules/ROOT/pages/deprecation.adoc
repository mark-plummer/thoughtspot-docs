...
:jira: SCAL-198582, SCAL-202496, SCAL-220961, SCAL-220962, SCAL-246119
...
IMPORTANT: Information about deprecated and removed features is subject to change without notice.
...
== Removed in 10.10.0.cl

The 10.10.0.cl release of ThoughtSpot Cloud, targeted for the June 2025, removes the following feature from the *Data workspace*:

- *Create new* > *Worksheet*
+
All existing Worksheets will be migrated automatically to Models in this release and Worksheets will no longer be available.

== Removed in 10.13.0.cl

The 10.13.0.cl release of ThoughtSpot Cloud, targeted for Fall 2025, removes the following features:

- Sage
- Ask Sage

Spotter replaces the previous Sage and Ask Sage features. For more information, see xref:spotter.adoc[Spotter].

== Deprecated in 10.9.0.cl

The 10.9.0.cl release of ThoughtSpot Cloud, targeted for May 2025, deprecates the following features:
...
You still have the option to use Sage, but you must contact your ThoughtSpot administrator to enable it. For more information, see xref:search-sage.adoc#_thoughtspot_sage_administration[ThoughtSpot Sage administration].

== Removed in 10.4.0.cl

The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024, removes the following feature from the *Data workspace*:
...
== Deprecated in 10.4.0.cl

The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024, deprecates the following feature from the *Data workspace*:
...
+
You can migrate an individual Worksheet to a Model, by doing the following:
+
. From the Data workspace page, open a Worksheet.
. Select the More menu image:icon-more-10px.png[more menu], and then *Convert to Model*.

+
Bulk migration of Worksheets to Models will be available in the 10.5.0.cl release.

=== IAMv1 migration to IAMv2
Enhanced Identity and Access Management (aka IAMv2) is being enabled for customers as part of maintenance windows for all ThoughtSpot Enterprise customers. IAMv1 support will be removed in an upcoming release.

Ensure you are ready for migration to IAMv2 by reviewing and following the steps in the documentation so that there is no login disruption for your users after migration.

For more information, see xref:oidc-iamv2.adoc[Identity and Access Management V2]. Accept in-product notifications for IAM updates. Contact {support-url} if you have any questions.


== Deprecated in 10.3.0.cl

The 10.3.0.cl release of ThoughtSpot Cloud, targeted for October 2024 (GA), deprecates the following feature. You can still use this feature, but ThoughtSpot will it in a later release.

- Sage Feedback Leaderboard

== Deprecated in 10.1.0.cl

The 10.1.0.cl release of ThoughtSpot Cloud, targeted for August 2024, deprecates the following features in the *Data workspace*. You can still use these features, but ThoughtSpot will remove these features in a later release.
...
== Removed in 10.1.0.cl

The 10.1.0.cl release of ThoughtSpot Cloud, targeted for August 2024, removes the following features:

Classic experience for Liveboards, Answers, and SpotIQ::
Beginning in the 10.1.0.cl release, you can no longer use the Classic experience for Liveboards, Answers, and SpotIQ. The "new experience" from the previous release is now the only option and is on by default.

Liveboard and Answers list pages::
...
The 9.12.0.cl release of ThoughtSpot Cloud, targeted for April 2024, will remove the following feature:
...
The 9.10.0.cl release of ThoughtSpot Cloud, targeted for February 2024, will deprecate the following feature. ThoughtSpot will drop support for this feature in a later release.

SpotApps::
Beginning in the 9.10.0.cl release, you can still use SpotApps, but ThoughtSpot will remove them in a subsequent release.

== Removed in 9.8.0.cl

The 9.8.0.cl release of ThoughtSpot Cloud, targeted for January 2024, will remove the following feature:
...
The 9.5.0.cl release of ThoughtSpot Cloud, targeted for July 2023, will remove the following feature:
...
The 9.4.0.cl release of ThoughtSpot Cloud, targeted for August 2023, removed the following feature:
...
The 9.2.0.cl release of ThoughtSpot Cloud, targeted for April 2023, will remove the following feature:
...
The 8.3.0.cl release of ThoughtSpot Cloud, targeted for April 2022, will *deprecate* the following features. ThoughtSpot will drop support for this feature in a later release.

include::partial$new-liveboard-experience-deprecations.adoc[]

== Removed in 8.2.0.cl (March Cloud)

The 8.2.0.cl (March Cloud) release of ThoughtSpot Cloud, targeted for March 2022, will drop support for the following feature:
...
The 8.0.0.cl (January Cloud) release of ThoughtSpot Cloud, targeted for January 2022, will drop support for the following feature:
...
The August Cloud release of ThoughtSpot Cloud, targeted for August 2021, will drop support for the following feature:
...
The May Cloud release of ThoughtSpot Cloud, targeted for May 2021, will drop support for the following features:
...
The May Cloud release of ThoughtSpot Cloud, targeted for May 2021, will deprecate the following features.
