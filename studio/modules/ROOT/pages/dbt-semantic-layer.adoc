...
link:https://cloud.google.com/looker/docs/sql-interface[For more information on how to query using Looker's Open SQL interface, see Looker's documentation,window=_blank].
