...
* link:http://d3js.org/[D3] (v3.5.17) and link:http://jquery.com/[JQuery] (v2.2.4), two JavaScript libraries commonly used for data visualization, are preloaded into all {brand} reports.
