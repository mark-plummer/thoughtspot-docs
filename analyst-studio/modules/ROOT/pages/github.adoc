...
When the branch containing `C*` is merged with the default branch, Report C in {brand} will updated to `C*`.
...
If your branch causes any issues, you can revert back to the previous version in GitHub.
