...
* When you're ready, generate new SQL on the right by clicking the Generate button (kbd:[Shift+Opt/Alt+N]).
...
* Once the generated code returns, you can compare it with your original code, insert the SQL in place of your original edits (kbd:[Shift+Opt/Alt+I]), or copy and paste manually as needed.
