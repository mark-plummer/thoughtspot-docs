...
* {brand} leverages link:https://platform.openai.com/docs/api-reference/introduction[OpenAI's GPT API].
...
To determine if your organization is an ideal fit for this opportunity, we kindly link:https://mode.com/lp/ai-assist-signup-form[request that you fill out this form].
